...
-   Markdown 常用格式支持；
-   代码高亮、行数显示支持；
-   目前版本支持的模版页：首页、文章详情页、归档页、Thoughts 想法页、单页；
-   中英文兼容，显示良好；
-   不支持评论。

## Thoughts 想法页

通过 Hexo 的自定义页面功能实现，放在 `source/thoughts/` 目录下。

**文件命名规范**（方便排序）：
- `YYYY-关键词.md` 或直接用中文标题
- 每篇文件需在 front-matter 中设置 `tags`

**front-matter 示例**：
```yaml
---
title: 标题
date: 2025-06-18 14:38:00
tags: [人生, 哲学]
---
正文，引用块直接用 Markdown blockquote 语法
```

**文章列表页**（`/thoughts`）：单列卡片布局，每张卡片包含引用内容 + 日期 + 标签。修改 `.thoughts-list` 相关 CSS 可调整布局。
